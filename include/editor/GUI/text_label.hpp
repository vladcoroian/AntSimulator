...
struct TextLabel : public Item {
  ...
  void onPositionChange() override { updateTextPosition(); }
  ...
  void updateOrigin() {
    ...
    switch (alignment) {
      case Alignment::Center:
        text.setOrigin(text_bounds.width * 0.5f - size.x * 0.5f,
                       text_bounds.height - size.y * 0.5f);
        break;
      case Alignment::Left:
        text.setOrigin({});
        break;
  ...
  void updateTextPosition() { text.setPosition(position); }
