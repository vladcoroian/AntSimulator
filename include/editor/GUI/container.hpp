...
struct Container : public Item {
  ...
  void addItem(ItemPtr item, const std::string& item_name = "") {
    ...
    watchSize(item, [this, item]() { updateItems(); });
    updateItems();
  }
  ...
  void onSizeChange() override { updateItems(); }
  ...
  float& getCoord2(sf::Vector2f& v) { return coord_2_accessor(v); }
  ...
  [[nodiscard]] bool isEmpty() const { return sub_items.empty(); }
  ...
  void fitContent() { size_type = {Size::FitContent, Size::FitContent}; }
